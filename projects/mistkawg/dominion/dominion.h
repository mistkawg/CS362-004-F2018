...
int cardFeast(struct gameState *state, int currentPlayer, int choice1, int handPos);
int cardCouncil_Room(struct gameState *state, int currentPlayer, int handPos);
